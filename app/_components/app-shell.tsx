...
export default function AppShell({
  ...
  return (
    <main className="flex min-h-svh items-center justify-center bg-[#E9EDE9] md:p-6">
      <section className="relative flex min-h-svh w-full max-w-[390px] flex-col bg-[#E9EDE9] p-4 md:min-h-[844px]">
        ...
        <div className={contentClassName ?? "flex h-full w-full flex-col gap-4 pt-4"}>
          {children}
        </div>
